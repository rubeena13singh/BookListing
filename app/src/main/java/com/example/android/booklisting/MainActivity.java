...
import static com.example.android.booklisting.Utilis.LOG_TAG;

public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<BookList>> {

    public static String BOOK_REQUEST_URL = "https://www.googleapis.com/books/v1/volumes?q=science&maxResults=10";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BOOK_REQUEST_URL = "https://www.googleapis.com/books/v1/volumes?q=" + searchQuery + "&maxResults=10";
